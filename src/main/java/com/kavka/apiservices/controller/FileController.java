...
import com.kavka.apiservices.service.ProductFileService;
...
public class FileController {
    ...
    /**
     * Provided the product Excel file it loads the data
     *
     * @param excel multipart excel file containing product data
     */
    @PostMapping("/load/products")
    @ResponseStatus(HttpStatus.OK)
    public void loadProducts(@RequestParam MultipartFile excel) throws IOException {
        if (Objects.requireNonNull(excel.getContentType()).contains("spreadsheet")) {
            XSSFWorkbook workbook = new XSSFWorkbook(excel.getInputStream());
            fileService.loadFromExcelWhole(workbook);
        }
    }
    ...
    /**
     * Provided the product details Excel file it loads the data
     *
     * @param excel multipart excel file containing prodct details
     */
    ...
    /**
     * Provided the path, it loads the products data
     *
     * @param path path to excel product file
     */
    @GetMapping("/load/products/path")
    ...
    /**
     * Provided the path, it loads the product details data
     *
     * @param path path to excel product details file
     */
    @GetMapping("/load/product-details/path")
