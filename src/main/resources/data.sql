...
values (null,'admin@example.com', true, 'admin_fname','admin_lname','$2a$12$wuqV4zO0jBAvlkO3RDBQ.edBZ2bYTjpW59xBZLKIHyZhJZ.3WMqe2');
insert into users (company, email, enabled, first_name, last_name, password)
values (null,'user@example.com', true, 'user_fname','user_lname','$2a$12$.Qw7/YMRMkCKCnMkc3fxh.Exj9IcTl9zQlFRI8EDz0KxUSMC4KJLa');
